...
const media = weekendCampingMedia["arriving-at-the-campsite"];
	...
	tasks: orderDialogueTasks(
		[
			...
			// Task 2
			{
				...
				options: ["Trong chiếc lều", "Khu cắm trại", "Trong xe", "Nhà của Mia"],
			...
			// Task 10
			{
				...
				grammar: {
					...
					example: "Do you need anything else? = Bạn có cần gì khác nữa không?",
				},
				scene: "/dialogue/weekend-camping/arriving-at-the-campsite/bg.png",
				character: {
					name: "Mia",
			...
			weekendCampingFillBlankTask(
				...
				"Leo",
				1,
				"We’re here! This place looks nice.",
			...
			weekendCampingFillBlankTask(
				...
				"Mia",
				4,
				"Okay. I’ll bring our bags over.",
				"Okay. I’ll bring our bags ",
				"over",
				".",
			),
			{
