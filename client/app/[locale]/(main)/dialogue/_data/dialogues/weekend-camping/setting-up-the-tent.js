...
const media = weekendCampingMedia["setting-up-the-tent"];
		...
		[
			...
			},
			{
				...
				grammar: {
					...
					explanation: "Dùng mẫu câu này để hỏi mình nên làm một việc ở đâu.",
			...
			weekendCampingFillBlankTask(
				...
				"Leo",
				3,
				"Yes, perfect. Hold it there for a second.",
				"Yes, perfect. ",
				"Hold",
			...
			weekendCampingFillBlankTask(
				...
				"Leo",
				4,
				"Now I’ll put this side up.",
				"",
				"Now",
				" I’ll put this side up.",
			),
			weekendCampingFillBlankTask(
				"24",
				"setting-up-the-tent",
			...
			),
			{
				...
				lines: [
					...
					},
					{
						speaker: "Leo",
						parts: [
							"Yes, perfect. Hold it there for a ",
							{ blank: "second", id: "5" },
							".",
						],
					},
