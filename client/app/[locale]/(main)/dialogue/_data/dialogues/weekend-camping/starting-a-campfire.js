...
const media = weekendCampingMedia["starting-a-campfire"];

const startingCampfireTaskMedia = (speaker, audioIndex) => ({
	scene: media.scene,
	character: {
		name: speaker,
		image: media.characters[speaker],
	},
	...
	tasks: orderDialogueTasks(
		[
...

			{
				...
				lines: [
					...
					},
					{
						speaker: "Leo",
						parts: [
							"Good idea. It’s getting a little ",
							{ blank: "cold", id: "3" },
							".",
						],
					},
			...
			weekendCampingFillBlankTask(
				...
				"Mia",
				1,
				"Yeah! Should we make a fire now?",
				"Yeah! Should we make a ",
				"fire",
				" now?",
			),
			weekendCampingFillBlankTask(
				...
				"Leo",
				2,
				"Good idea. It’s getting a little cold.",
				"Good ",
				"idea",
			...
			weekendCampingFillBlankTask(
				...
				"Leo",
				4,
				"Almost. Let’s get a few more pieces.",
				"Almost. Let’s get a few more ",
				"pieces",
				".",
			),
